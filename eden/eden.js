...
var exponates = d3.range(1, n+1).map(function(i) {
  with (Math) {
     var x0 = width * i/5,
         ...
         r1 = 20,
         r2 = 80,
         largeribsleftrelative = d3.range(PI/2, 3*PI/2, PI/80).map(function(phi) {
         ...
         eye = eye_raw.map(function (o) { return {x: o.x+5*random(), y: o.y+5*random()}}),
         hand = hand_raw.map(function (o) {
            return {x: o.x+5*random(), y: o.y+5*random()
         }});
     return {
       largeribs: largeribsleftrelative.concat([...largeribsleftrelative].reverse().map(function (o) {
          return {x: -o.x, y: o.y};})).map(function (o) { return {x: x0+o.x, y: y0+o.y};
       }),
